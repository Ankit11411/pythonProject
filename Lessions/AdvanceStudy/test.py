...
class main_box:
    ...
    def Remove(a):
        if a == 120:
            main_box.dict[1] = 'empty'
        if a == 170:
            main_box.dict[2] = 'empty'
        if a == 220:
            main_box.dict[3] = 'empty'
        if a == 270:
            main_box.dict[4] = 'empty'
        if a == 320:
            main_box.dict[5] = 'empty'
        if a == 370:
            main_box.dict[6] = 'empty'
        if a == 420:
            main_box.dict[7] = 'empty'
        if a == 470:
            main_box.dict[8] = 'empty'
