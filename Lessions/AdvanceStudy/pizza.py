...
def pizza_box():
    ...
    def review():
        ...
        try:
            ...
            if cb2.get() == '':
                ...
                l9.config(text='Please Select type')
    ...
    r7 = Radiobutton(pz, text='Small', bg='gold2', variable=v1, value=1)
    r7.place(x=200, y=240)
    r8 = Radiobutton(pz, text='Medium', bg='gold2', variable=v1, value=2)
    r8.place(x=300, y=240)
    r9 = Radiobutton(pz, text='Large', bg='gold2', variable=v1, value=3)
    ...
    l7 = Label(pz, text='Address', font='Times 16 bold', bg='gold2').place(x=50, y=320)
    e9 = Text(pz, width=25, height=2, font='Times 14')
    e9.insert(END, str(q1))
    e9.place(x=150, y=320)
    l9 = Label(pz, text='', font='Times 16 bold', bg='gold2')
    l9.place(x=400, y=100)

    b2 = Button(pz, text='Review', command=review).place(x=10, y=450)
    b3 = Button(pz, text='Place Order').place(x=100, y=450)
...
l1 = Label(ap, text='Username ', font='Times 14 bold', bg='white').place(x=35, y=35)
e1 = Entry(ap, width=22, font='Times 20 ', bg='lightyellow')
e1.place(x=40, y=70)

l2 = Label(ap, text='Password ', font='Times 14 bold', bg='white').place(x=35, y=130)
